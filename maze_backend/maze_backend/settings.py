"""
Django settings for maze_backend project.
...
SECRET_KEY = 'django-insecure-0)u@eykn8##$l7#o6k^du_g8e_0y4nqz!2zjmfad1xyvsb(cve'
...
ROOT_URLCONF = 'maze_backend.urls'
...
WSGI_APPLICATION = 'maze_backend.wsgi.application'
